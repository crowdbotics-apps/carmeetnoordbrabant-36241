...
## Project Structure
    ...
    ├── carmeetnoordbrabant_36241  # Django project configurations
...
1. Clone this repo and `cd carmeetnoordbrabant_36241`
...
2. Clone this repo and `cd carmeetnoordbrabant_36241`
